    ...
    <div className="relative">
      ...
      >
        ...
        {!isSidebarOpen && (
          <button
            onClick={toggleSidebar}
            className="text-white p-2 absolute top-0 left-0"
          >
            <BsList size={30} />
          </button>
        )}
        <div className="flex flex-col py-8">
          {isSidebarOpen && (
            <div className="flex flex-col justify-between flex-1 mt-1">
              <nav>
                <h2 className="text-3xl font-semibold text-white mt-5 mx-4">
                  Menu
                </h2>
                ...
                <div
                  onClick={toggleEvicMenu}
                  className="flex items-center mt-5 px-1 py-2 text-white cursor-pointer"
                >
